...
imp_data <- read_delim("all-data.csv", delim = ";", 
    escape_double = FALSE, trim_ws = TRUE)
maternal_mortality_2000 <- read_delim("maternal_mortality_2000.csv", 
                                      delim = ";", escape_double = FALSE, trim_ws = TRUE)
maternal_mortality_2020 <- read_delim("maternal_mortality_2020.csv", 
                                      delim = ";", escape_double = FALSE, trim_ws = TRUE)
